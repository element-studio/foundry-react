        ...
        return (
            <fieldset className={'field_set'}>
                <div className="field_wrapper">
                    {this.props.label ? (
                        <label htmlFor={this.props.name} className="text_input_label text_area_label type-label" data-label={this.props.label}>
                            {this.props.label}
                        </label>
                    ) : null}
                    <textarea
                        className={
                            'text_input ' +
                            this.props.classes +
                            (this.state.value && this.state.value != '' ? ' _has-value' : ' ') +
