            ...
            <fieldset className="field_set">
                <div className='field_wrapper'>
                    ...
                    <ul className="yes_no_list">
                        <li className={"yes_no_list_item" + (this.state.value == 1 ? ' _is-active' : '') } onClick={this.handle_change.bind(this, '1')}>Yes</li>
                        <li className={"yes_no_list_item" + (this.state.value == 0 ? ' _is-active' : '') } onClick={this.handle_change.bind(this, '0')}>No</li>
                    </ul>
